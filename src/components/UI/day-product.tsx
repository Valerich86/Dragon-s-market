  ...
  return (
    <Link href={href} className="w-full lg:w-auto flex justify-center">
      <div className="w-1/2 lg:w-full relative">
        ...
        <div className={`bg-[url("/images/paint.webp")] h-full w-full bg-size-[80%] bg-no-repeat absolute left-1/2 top-[70%] flex justify-center pt-1 pr-10 lg:pr-20 text-xl lg:text-3xl`}>
          Товар дня
        </div>
      </div>
    </Link>
