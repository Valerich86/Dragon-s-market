...
const buttonStyle = "w-20 py-1 uppercase rounded hover:opacity-90 active:scale-95";

export default function Notification({ text, onAccept, onAbort }: Props) {
  return (
    <div
      ...
      ${!onAccept ? "animate-message" : ""}`}
    >
      <div className="w-[90vw] py-5 gap-5 md:w-3/5 lg:w-1/3 flex flex-col items-center justify-center bg-primary text-secondary rounded-md p-2">
