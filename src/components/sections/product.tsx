...
export default function ProductSection({ product, cloudPath, userId }: Props) {
  return (
    <div className="w-full min-h-screen flex flex-col gap-10 md:flex-row bg-primary justify-center md:items-start py-20">
      <div
        className={`w-full md:w-1/2 h-[50vh] md:h-[80vh] flex items-center justify-center p-3`}
      >
      ...
      <div className="w-full md:w-1/2 md:p-3 flex flex-col gap-5">
