...
Мёд или вишня в глазури?
Вздох — берёт всё сразу.`,
    type: "about",
    text: `Наш уютный магазинчик готов удивлять! Вот лишь несколько сокровищ из нашего азиатского ассортимента, которые ждут тебя на полках:
...
И это только начало! Каждый вкус — как маленькое путешествие по Азии. Что из этого манит тебя больше всего? 😋`,
...

  {
    ...
    title: null,
    type: "assortment",
    text: `🔥Соевое мясо — это растительный продукт, сделанный из соевого белка. 
...
Представь: ты берёшь упаковку сушёных топоки, которые легко приготовить дома и классно проводишь вечер смотря новую серию любимого аниме! Это ли не счастье?😋`,
...

  {
    ...
    title: null,
    type: "assortment",
    text: `Моти — нежные японские рисовые десерты, мягкие, как облако, с сочной начинкой, что тает во рту. На Драконьем Базаре они добавляют магии и восточного шарма в твои дни! Успей схватить — улетают быстрее драконов!
